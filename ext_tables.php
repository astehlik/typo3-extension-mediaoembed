...
/**
 * Table "tx_mediaoembed_provider_regex":
...
$TCA['tx_mediaoembed_provider_regex'] = array(
	'ctrl' => array(
		...
		'title' => 'LLL:EXT:mediaoembed/Resources/Private/Language/locallang_db.xml:tx_mediaoembed_provider_regex',
		'dynamicConfigFile' => t3lib_extMgm::extPath('mediaoembed', 'Configuration/TCA.php'),
	)
);
