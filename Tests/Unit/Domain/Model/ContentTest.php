...
class ContentTest extends TestCase
{
    ...
    {
        $this->assertSame('12:2', $this->contentElement->getAspectRatio());
    }

    public function testGetMaxHeight(): void
    {
        $this->assertSame(12, $this->contentElement->getMaxHeight());
    }

    public function testGetMaxWidth(): void
    {
        $this->assertSame(43, $this->contentElement->getMaxWidth());
    }

    public function testGetUid(): void
    {
        $this->assertSame(10, $this->contentElement->getUid());
    }

    public function testGetUrl(): void
    {
        $this->assertSame('https://the.media.url', $this->contentElement->getUrl());
    }

    public function testShouldPlayRelated(): void
    {
        $this->assertFalse($this->contentElement->shouldPlayRelated());
    }
}
